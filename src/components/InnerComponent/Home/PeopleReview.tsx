    ...
    <section className="bg-black px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          <h2 className="text-center text-4xl font-bold sm:text-5xl lg:text-left">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={prevReviews}
              className="group p-3 rounded-full bg-gradient-to-r from-[#ff8a00] via-[#ff2e7a] to-[#ff007a] hover:shadow-lg transition-all duration-300 hover:scale-110"
            >
              <svg 
                className="w-6 h-6 text-white transform rotate-180 group-hover:scale-110 transition-transform" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
            ...
            >
              {currentReviews.map((review, index) => (
                <motion.div
                  ...
                  className="overflow-hidden rounded-xl bg-white p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300"
                >
                  <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between rounded-xl bg-black px-4 py-4 gap-4">
                    <div className="flex items-center gap-4">
                      <div className="h-14 w-14 sm:h-16 sm:w-16 flex items-center justify-center rounded-full bg-gradient-to-br from-[#ff8a00] to-[#800080] flex-shrink-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-sm sm:text-lg text-white/70 truncate">{review.title}</p>
                      </div>
                    </div>
                    <a
                      ...
                      className="group rounded-full bg-gradient-to-r from-[#ff8a00] via-[#ff2e7a] to-[#ff007a] p-2 transition-all duration-300 hover:scale-110 hover:shadow-lg self-center sm:self-auto flex-shrink-0"
                      aria-label="Follow on Instagram"
                    >
                      <Instagram className="h-6 w-6 sm:h-7 sm:w-7 text-white group-hover:scale-110 transition-transform" />
                    </a>
                  </div>
                  <p className="text-black text-sm sm:text-base leading-relaxed">{review.content}</p>
                </motion.div>
              ))}
            </motion.div>
          </AnimatePresence>
